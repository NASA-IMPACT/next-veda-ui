---
title: "Biodiversity"
description: "Our Earth is home to millions of species on land and in water. Explore data from across the federal government on biological diversity and how Earth observations are used to better understand interactions between species, ecosystems, and the broader Earth system."
...
resources:
  - title: "INTRODUCTION TO BIODIVERSITY"
    ...
    linkURL: "https://storymaps.arcgis.com/stories/5be6fd4da6e0451b801fd50e9414ca21"
    imgSrc: "/images/themes/biodiversity/intro-to-biodiversity.png"
    imgAlt: "Introduction to biodiversity"
---
...
<Section>
  ...
  <Paragraph>
    Biodiversity refers to the variety, or diversity, of all life on Earth. Environmental factors including temperature, precipitation, and land cover directly impact the ability of species to survive and the habitats where they are found.
  </Paragraph>

  <Paragraph>
    Researchers working on the ground in a species’ habitat directly monitor these factors on a local scale, while researchers using remote sensing techniques study biodiversity from space-based and airborne missions. Both approaches provide critical information and a better understanding of species habitat and distribution across the globe. This information can also be used in models to forecast how habitat or species distribution may change in the future and can be used across multiple scales to inform management practices.
  </Paragraph>
...
<Section full>
  <Title>BIODIVERSITY STORIES</Title>
