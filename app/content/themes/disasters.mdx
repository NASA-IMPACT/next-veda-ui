---
title: "Disasters"
description: "Learn how technology in the sky can build resilience on the ground by providing actionable data that allows responders prepare for disasters, map widespread damage, and guide recovery."
...
<Section>
  ...
  <Paragraph>
    Hurricanes, tropical cyclones, blizzards, landslides, floods, and droughts are examples of frequently occurring disasters. When disasters do arrive in communities, they can be costly and damaging. Actionable data from Earth observations paired with data collected on the ground can be rapidly shared across agencies before, during, and after disasters strike. Through coordination with decision-makers, actionable data can be used to prepare, respond, and recover from the effects of disasters. 
  </Paragraph>
