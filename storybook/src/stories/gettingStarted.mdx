...
![VEDA logo](https://raw.githubusercontent.com/NASA-IMPACT/veda-ui/refs/heads/main/docs/media/nasa-veda-logo-pos.svg./docs/media/nasa-veda-logo-pos.svg)
...
- Check [CONFIGURATION](.stories/Content.mdx) to see a list of configuration options for VEDA.
- Check [CONTENT](/docs/content--docs) for how to structure the content pieces.
