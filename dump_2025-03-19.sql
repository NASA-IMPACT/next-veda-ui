...
13	yb9q1485cnplv1a3kipz9oi2	demo story	this is a demo	demo	\N	Wildfire	2025-03-18 21:32:47.341	2025-03-19 21:00:34.016	\N	1	1	\N
30	yb9q1485cnplv1a3kipz9oi2	demo story	this is a demo	demo	\N	Wildfire	2025-03-18 21:32:47.341	2025-03-19 21:00:34.016	2025-03-19 21:00:34.122	1	1	\N
...
100	13	13	shared.rich-text	blocks	1
101	13	1	shared.media	blocks	2
102	13	1	shared.line-graph	blocks	3
103	13	1	shared.map	blocks	4
104	13	1	shared.graph-with-desc	blocks	5
105	30	26	shared.rich-text	blocks	1
106	30	10	shared.media	blocks	2
107	30	10	shared.line-graph	blocks	3
108	30	7	shared.map	blocks	4
109	30	3	shared.graph-with-desc	blocks	5
...
12	Nasa	https://nasa.gov	Comparison of nightlights data for Puerto Rico pre-landfall (17 July 2017) and post-landfall (20 September 2017) for Hurricane Maria.\n
16	Nasa	https://nasa.gov	Comparison of nightlights data for Puerto Rico pre-landfall (17 July 2017) and post-landfall (20 September 2017) for Hurricane Maria.\n
17	NASA	https://nasa.gov	 Harmonized Landsat 8 SWIR image provides enhanced contrast to detect flood extent in Puerto Rico before and after Hurricane Maria in 2017.
18	Nasa	https://nasa.gov	Comparison of nightlights data for Puerto Rico pre-landfall (17 July 2017) and post-landfall (20 September 2017) for Hurricane Maria.\n
\.
...
1	1	7	shared.mdx-block	sectionDesc	\N
2	1	7	shared.line-graph	lineGraph	\N
7	3	9	shared.mdx-block	sectionDesc	\N
8	3	11	shared.line-graph	lineGraph	\N
\.
...
7	MM/YYY	Zip	Month	Number of Tarps
10	MM/YYY	Zip	Month	Number of Tarps
11	MM/YYY	Zip	Month	Number of Tarps
\.
...
11	7	12	shared.caption	Attribution	\N
17	10	16	shared.caption	Attribution	\N
18	11	18	shared.caption	Attribution	\N
\.
...
7	11.00	2017-08-25	2017-09-25	[-65.97, 18.41]	hls-l30-002-ej	hls_events
\.
...
12	7	17	shared.caption	Caption	\N
\.
...
88	3	1	shared.media	file	1
89	5	1	shared.line-graph	dataPath	1
90	5	7	shared.line-graph	dataPath	1
24	1	1	api::article.article	cover	1
25	1	12	api::article.article	cover	1
91	4	13	api::article.article	cover	1
92	3	10	shared.media	file	1
93	5	10	shared.line-graph	dataPath	1
94	5	11	shared.line-graph	dataPath	1
95	4	30	api::article.article	cover	1
...
SELECT pg_catalog.setval('public.articles_cmps_id_seq', 109, true);
...
SELECT pg_catalog.setval('public.components_shared_captions_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.components_shared_graph_with_descs_cmps_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.components_shared_graph_with_descs_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.components_shared_line_graphs_cmps_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.components_shared_line_graphs_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.components_shared_maps_cmps_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.components_shared_maps_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.components_shared_mdx_blocks_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.components_shared_media_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.components_shared_rich_texts_id_seq', 26, true);
...
SELECT pg_catalog.setval('public.components_shared_side_by_sides_cmps_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.files_related_mph_id_seq', 95, true);
